...
async def help_message_f(client, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/MoviesMiniPlex')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/Filez2LinkBOtSupport')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/IAmironBoy'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://t.me/WaterMarkBotSourceCode') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
